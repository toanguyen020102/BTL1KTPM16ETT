...
public class ThongKeDoanhThu_DAO {
	public ArrayList<ThongKeDoanhThu> thongKeDoanhThuNV(Object NgayMoc,Object ngayDen){
		...
		String sql = "select Nhanvien.tenNhanVien, COUNT(Hoadon.maNhanVien), sum(Hoadon.tongtien) as TienNhan from HoaDon INNER JOIN Nhanvien  on Nhanvien.maNhanvien = Hoadon.maNhanvien  where  thoigiantaohoadon  >= "
				+ "? and "
	...
	public ArrayList<ThongKeDoanhThu> thongKeDoanhThuKH(Object NgayMoc,Object ngayDen){
		ArrayList<ThongKeDoanhThu> tkdt = new ArrayList<>();
		Connection con = new Connect_DB().getConnection();
		String sql = "select KhachHang.tenKhachHang, COUNT(Hoadon.maKhachHang), sum(Hoadon.tongPhaiTra) from HoaDon  \r\n"
				+ "INNER JOIN\r\n"
